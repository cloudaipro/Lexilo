...
> Defined 2026-08-09 from the user-supplied 1024×1024 logo. Asset completeness: sufficient for V1.
...
- Paper: `#FBF7F2` — primary canvas.
- Deep paper: `#F1EBE2` — quiet grouping surface.
- Ink: `#131E30` — typography and primary actions.
- Sage: `#5B8374` — learning state and positive action.
- Brass: `#A5773F` — fine dividers, labels, and restrained emphasis.
- Danger: `#9F473D` — “Don’t know” action only.
- Display typography: iOS serif system face; body typography: iOS system face for compact legibility.
