...
- Small and medium Home Screen plus inline, circular, and rectangular Lock Screen WidgetKit widgets backed by an App Group study snapshot; each refresh advances through today’s words in order and wraps around, while tapping a widget opens Today’s words directly and the medium widget shows the full definition or example selected in Settings (Definition by default)
